...
@XmlSeeAlso(
  { cl.com.ccla.type.ObjectFactory.class })
public interface TbkWS
{
  @WebMethod
  @Action(input="http://ws/TbkWS/initTbkRequest", output="http://ws/TbkWS/initTbkResponse")
  @ResponseWrapper(localName="initTbkResponse", targetNamespace="http://ws/",
  ...
  @WebMethod
  @Action(input="http://ws/TbkWS/getResultadoRequest", output="http://ws/TbkWS/getResultadoResponse")
  @ResponseWrapper(localName="getResultadoResponse", targetNamespace="http://ws/",
